...
Homework:
- look through shiny app for anything interesting when filtering by investigation characteristics (but not by series) --> monster_type, number of snacks
- update slides for Wednesday with anything interesting that was found with filtering
- finish the write-up by adding anything interesting that was found when filtering
- need to put shiny app in a different link
...
To turn in:
- a link to your GitHub repository for the project.
- a written report (in Quarto), embedded with the visualizations you have constructed and the code used to construct these visualizations.
- a link to the script creating a Shiny app.
- a link to your blog with an updated blog post on your final project.
