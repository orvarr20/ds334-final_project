...
To do for homework:
-finish fixing catchphrase Count variable so that it graphs for all of them (changing NULLs to 0s)
-for other variables, manually make a count, need to change NULLs to 0
-finish adding catchphrase to Shiny app including a table of the counts